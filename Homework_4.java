...
public class Homework_4 {
    ...
    public static List<String> correctedList(List<String> stringList) {
        ...
        for (int i = 0; i < stringList.size(); i++) {
            ans.add(stringList.get(i).toLowerCase());
        }
        return ans;
    }
    ...
    public static class AntiCheat {
        public static void run() {
            ...
            antiCheatList.addAll(Homework_4.setMagazine().keySet().stream().map(Object::toString).toList());
            antiCheatList.addAll(Homework_4.setlungsCheck().values().stream().map(Object::toString).toList());
