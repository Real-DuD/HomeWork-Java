...
public class Homework_5 {
    ...
    */
    ...
    public static class Person {
        ...
        public void takeDamage(Integer damage) throws Exception {
            if (damage < 0) {
                throw new Exception();
            } else if (this.health - (damage - this.protection) <= 0) {
                this.health = 0;
            } else {
   ...
   */
    public static void main(String[] args) throws Exception {
        ...
        test("Mage: announce() содержит защиту", mage.announce().contains(MAGE_PROTECTION.toString()));
